  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled ? 'bg-black/95 backdrop-blur-md shadow-2xl border-b border-gray-700' : 'bg-transparent'
      }`}>
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('projetos')} className="text-gray-300 hover:text-green-400 transition-colors">
                Projetos
              </button>
              <button onClick={() => scrollToSection('tecnologia')} className="text-gray-300 hover:text-green-400 transition-colors">
                Tecnologia
              </button>
              <button onClick={() => scrollToSection('instagram')} className="text-gray-300 hover:text-green-400 transition-colors">
                Instagram
              </button>
              <button onClick={() => scrollToSection('contato')} className="text-gray-300 hover:text-green-400 transition-colors">
                Contato
              </button>
              <button onClick={openWhatsApp} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md flex items-center transition-colors">
          ...
          {isMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 border-t border-gray-700">
              <div className="flex flex-col space-y-4 pt-4">
                <button onClick={() => scrollToSection('inicio')} className="text-left text-gray-300 hover:text-green-400">
                  Início
                </button>
                <button onClick={() => scrollToSection('sobre')} className="text-left text-gray-300 hover:text-green-400">
                  Sobre
                </button>
                <button onClick={() => scrollToSection('servicos')} className="text-left text-gray-300 hover:text-green-400">
                  Serviços
                </button>
                <button onClick={() => scrollToSection('projetos')} className="text-left text-gray-300 hover:text-green-400">
                  Projetos
                </button>
                <button onClick={() => scrollToSection('tecnologia')} className="text-left text-gray-300 hover:text-green-400">
                  Tecnologia
                </button>
                <button onClick={() => scrollToSection('instagram')} className="text-left text-gray-300 hover:text-green-400">
                  Instagram
                </button>
                <button onClick={() => scrollToSection('contato')} className="text-left text-gray-300 hover:text-green-400">
                  Contato
                </button>
      ...
      <section 
        id="inicio" 
        className="pt-24 pb-16 px-4 relative bg-gradient-to-br from-gray-900 via-blue-900 to-green-900"
      >
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6 inline-block bg-green-500/20 text-green-400 px-4 py-2 rounded-full border border-green-500/30">
            ...
            <p className="text-lg text-gray-400 mb-10 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button 
                ...
                className="bg-green-600 hover:bg-green-700 text-white text-lg px-8 py-6 rounded-md flex items-center transition-colors shadow-lg"
              >
              ...
              <button 
                ...
                className="border-2 border-gray-400 text-gray-300 hover:bg-gray-400 hover:text-gray-900 text-lg px-8 py-6 rounded-md flex items-center transition-colors"
              >
      ...
      <section id="sobre" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              <Lightbulb className="w-12 h-12 mx-auto text-green-400 mb-4" />
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Nossos Valores</h3>
              <p className="text-gray-400">
      ...
      <section id="servicos" className="py-20 bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Agronegócio */}
            <div className="bg-gray-900 p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow border border-gray-700">
              <div className="text-center mb-6">
                <Wheat className="w-16 h-16 mx-auto text-green-400 mb-4" />
                <h3 className="text-2xl font-bold text-white">Para o Agronegócio</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-white">Vigilância Abrangente</div>
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-semibold text-white">Segurança Off-Grid</div>
                    <div className="text-sm text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-semibold text-white">WiFi Rural de Alto Desempenho</div>
                    <div className="text-sm text-gray-400">
              ...
              <button onClick={openWhatsApp} className="w-full mt-6 bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-md flex items-center justify-center transition-colors">
                <MessageCircle className="w-4 h-4 mr-2" />
            ...
            <div className="bg-gray-900 p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow border border-gray-700">
              <div className="text-center mb-6">
                <Building className="w-16 h-16 mx-auto text-blue-400 mb-4" />
                <h3 className="text-2xl font-bold text-white">Para o Setor Comercial</h3>
                <p className="text-lg text-gray-400">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-white">Detecção Precisa de Ameaças</div>
                    <div className="text-sm text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-semibold text-white">WiFi Corporativo</div>
                    <div className="text-sm text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-semibold text-white">Soluções Integradas</div>
                    <div className="text-sm text-gray-400">
              ...
              <button onClick={openWhatsApp} className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-md flex items-center justify-center transition-colors">
                <MessageCircle className="w-4 h-4 mr-2" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <Wifi className="w-8 h-8 text-blue-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-white">WiFi Público</h3>
                  <p className="text-gray-400">
              ...
              <div className="flex items-start space-x-4">
                <Globe className="w-8 h-8 text-green-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-white">WiFi Corporativo</h3>
                  <p className="text-gray-400">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-white">Site Survey Profissional</h3>
                  <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-700">
              <h3 className="text-2xl font-bold mb-6 text-center text-white">Nossos Diferenciais WiFi</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-gray-300">Cobertura até 50.000+ m²</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-gray-300">Equipamentos Ubiquiti certificados</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-gray-300">Gerenciamento via UniFi Controller</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
                  <span className="text-gray-300">Garantia e manutenção incluídas</span>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <div className="flex items-center justify-center mb-8">
              ...
              <h3 className="text-3xl font-bold text-white">Projetos Executados</h3>
            </div>
            
            <div className="grid lg:grid-cols-2 gap-8">
              {projetosExecutados.map((projeto) => (
                <div key={projeto.id} className="bg-gray-900 p-6 rounded-lg shadow-xl hover:shadow-2xl transition-shadow border border-gray-700">
                  <div className="flex justify-between items-start mb-4">
                    <h4 className="text-lg font-bold text-white">{projeto.titulo}</h4>
                    <span className="bg-green-500/20 text-green-400 px-3 py-1 rounded-full text-sm border border-green-500/30">{projeto.categoria}</span>
                  </div>
          ...
          <div>
            <div className="flex items-center justify-center mb-8">
              ...
              <h3 className="text-3xl font-bold text-white">Projetos em Andamento</h3>
            </div>
            ...
            <div className="grid lg:grid-cols-1 gap-8">
              {projetosAndamento.map((projeto) => (
                <div key={projeto.id} className="bg-gray-900 p-6 rounded-lg shadow-xl hover:shadow-2xl transition-shadow border border-gray-700">
                  <div className="flex justify-between items-start mb-4">
                    <h4 className="text-lg font-bold text-white">{projeto.titulo}</h4>
                    <span className="bg-blue-500/20 text-blue-400 px-3 py-1 rounded-full text-sm border border-blue-500/30">{projeto.categoria}</span>
                  </div>
                  <p className="text-gray-400 mb-4">{projeto.descricao}</p>
      ...
      {/* Technology Section */}
      <section id="tecnologia" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
              Nossa Tecnologia
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              <Eye className="w-12 h-12 mx-auto text-blue-400 mb-4" />
              <h3 className="text-xl font-bold mb-4 text-white">Inteligência Artificial</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Análise Preditiva</h3>
              <p className="text-gray-400 mb-4">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Pesquisa Rápida</h3>
              <p className="text-gray-400 mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            <button 
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-lg px-8 py-6 rounded-md flex items-center mx-auto transition-colors"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Especialização Dupla</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              <Cpu className="w-12 h-12 mx-auto text-green-400 mb-4" />
              <h3 className="text-xl font-bold mb-4 text-white">Tecnologia de Ponta</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              <Award className="w-12 h-12 mx-auto text-blue-400 mb-4" />
              <h3 className="text-xl font-bold mb-4 text-white">Parceria de Confiança</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Soluções Personalizadas</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              ...
              <h3 className="text-xl font-bold mb-4 text-white">Tranquilidade Total</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl text-center hover:shadow-2xl transition-shadow border border-gray-700">
              <Clock className="w-12 h-12 mx-auto text-green-400 mb-4" />
              <h3 className="text-xl font-bold mb-4 text-white">Suporte 24/7</h3>
              <p className="text-gray-400">
      ...
      {/* Contact Section */}
      <section id="contato" className="py-20 bg-gradient-to-br from-gray-900 via-blue-900 to-green-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button 
                onClick={openWhatsApp}
                className="bg-green-600 hover:bg-green-700 text-lg px-8 py-6 rounded-md flex items-center transition-colors shadow-lg"
              >
                <MessageCircle className="w-5 h-5 mr-2" />
            ...
            <div className="mt-8 flex items-center justify-center text-lg text-gray-400">
